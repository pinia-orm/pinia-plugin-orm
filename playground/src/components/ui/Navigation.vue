...
<template>
  <div
    ...
    spcae="y-2"
  >
    <a href="https://pinia-orm-org.vercel.app" alt="Pinia Plugin ORM - Documentation"><img src="/logo.svg" class="w-12"></a>
    <span class="flex-1" />
    <Button
      icon
      text="base"
    ...
    <a href="https://github.com/pinia-orm/pinia-plugin-orm" target="_blank">
      <Button
        icon
        text="base"
      >
