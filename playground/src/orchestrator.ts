  ...
  users: [
    {
      id: 1,
      name: 'Elone Hoo',
      avatarImgUrl: 'https://github.com/elonehoo.png',
      firstName: 'Elone',
      lastName: 'Hoo',
      todos: [
        {
...
const initialPackages = [
  ...
  {
    name: '@pinia-plugin-orm/normalizr',
    source: 'unpkg',
    description: 'Pinia ORM normalizr',
    url: 'https://unpkg.com/@pinia-plugin-orm/normalizr@0.0.2/dist/index.js',
  },
  {
  ...
  },
  {
    ...
    source: 'unpkg',
    description: 'Pinia Plugin ORM',
    url: 'https://unpkg.com/pinia-plugin-orm@0.0.2/dist/index.js',
  },
]
...
function loadInitialState() {
  ...
  if (location.hash.slice(1)) {
    ...
    addFile(new OrchestratorFile('data.ts', '', dataScript.trim()))
    addFile(new OrchestratorFile('User.ts', '', modelUserScript.trim()))
    addFile(new OrchestratorFile('Todo.ts', '', modelToDoScript.trim()))
    setActiveFile('App.vue')
    shouldUpdateContent.trigger(null)
  }
}
